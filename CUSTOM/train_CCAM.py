...
path_dataset_polyp = "D:\\Study\\Conda Projects\\Polyp Detection\\Kvasir-SEG\\Original\\"
# path_dataset_oxford = "D:\\Study\\Conda Projects\\CCAM\\CUSTOM\\data\\images\\"
parser.add_argument('--data_dir', default=path_dataset_polyp, type=str)
...
if __name__ == '__main__':
    ...
    for epoch in range(args.max_epoch):
        ...
        for iteration, (images, image_names) in enumerate(train_loader):
            ...
            if (iteration + 1) % val_iteration == 0:
                ...
                # visualize_heatmap(args.tag, images.clone().detach(), ccam, epoch, iteration, seg=True)
                # visualize_heatmap(args.tag, images.clone().detach(), image_names, ccam, epoch, iteration, seg=True)
            ...
            if epoch==args.max_epoch-1:
                visualize_heatmap(args.tag, images.clone().detach(), image_names, ccam, epoch,0,seg=True)
        #################################################################################################
        # Evaluation
        #################################################################################################
        save_model_fn()
